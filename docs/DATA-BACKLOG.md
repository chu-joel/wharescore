...
| Cycling infrastructure | OSM Overpass API (16 cities) + bike POIs from osm_amenities | Line + Point | PostGIS + osm_amenities | **Loader ready** | Cycleway km within 2km + bike facility count. |
