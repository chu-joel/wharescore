...
| `community_facilities` | Object | `osm_amenities` + `fibre_coverage` + `cycleways` spatial queries. Nearest hospital, EV charger, library/sports/playground/community centre/cycling counts, fibre availability, cycleway km within 2km. | HostedNeighbourhoodStats |
