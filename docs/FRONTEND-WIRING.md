...
| `liveability.bus_stops_800m, .rail_stops_800m, .ferry_stops_800m` | TransportSection | "Transport" | No |
...
|--------|------|:----:|------|---------|-------------------|
| GET | `/property/{id}/report` | No | 20/min | Full property report | get_property_report() SQL, _fix_unit_cv(), _overlay_transit_data() |
