...
| `community_facilities` | Object | `osm_amenities` spatial queries. Nearest hospital, EV charger, library/sports/playground/community centre counts within 2km. | HostedNeighbourhoodStats |
