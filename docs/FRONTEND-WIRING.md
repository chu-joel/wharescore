...
|---|---|---|---|---|---|
| POST | `/admin/reinz-hpi/upload` | admin | — | Upsert a month of REINZ TA HPI data. Body: `{month_end, rows[{ta_name, hpi, calculated, change_*_pct}]}`. Source: REINZ monthly PDF (page 14 full TA index + page 6 movement cols). | reinz_hpi_ta |
