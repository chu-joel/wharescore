    ...
    el.innerHTML = `
      <div style="position:relative;">
        <div style="position:absolute;inset:-12px;display:flex;align-items:center;justify-content:center;">
          <div style="width:24px;height:24px;border-radius:50%;background:${color}33;animation:pulse-ring 1.5s cubic-bezier(0,0,0.2,1) infinite;"></div>
        </div>
        <svg width="32" height="32" viewBox="0 0 24 24" fill="${color}" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="filter:drop-shadow(0 2px 4px rgba(0,0,0,0.3));animation:bounce-in 0.5s cubic-bezier(0.34,1.56,0.64,1) forwards;">
