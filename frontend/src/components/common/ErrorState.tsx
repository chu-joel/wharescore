...
type ErrorVariant = 'network' | 'timeout' | 'section' | 'not-found' | 'rate-limit';
...
const errorConfig: Record<ErrorVariant, { icon: typeof WifiOff; title: string; defaultMessage: string }> = {
  'network': { icon: WifiOff, title: 'Connection issue', defaultMessage: 'Check your internet connection and try again.' },
