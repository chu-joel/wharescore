...
DATA_SOURCES: list[DataSource] = [
    ...
    DataSource("auckland_rates", "Auckland Rates/Valuations (623K)",
        ...
        lambda conn, log=None: _load_rates(conn, log,
            ...
            "auckland", "CV", "LV", None, "FORMATTEDADDRESS")),
    ...
    # ══════════════════════════════════════════════════════════
    DataSource("hamilton_gtfs", "Hamilton BUSIT GTFS",
        ["transit_stops"],
    ...
    DataSource("dunedin_gtfs", "Dunedin Orbus GTFS",
        ["transit_stops"],
        lambda conn, log=None: _load_regional_gtfs(conn, log,
            "https://www.orc.govt.nz/transit/google_transit.zip", "dunedin")),
    DataSource("nelson_gtfs", "Nelson eBus GTFS",
        ["transit_stops"],
        lambda conn, log=None: _load_regional_gtfs(conn, log,
            "https://data.trilliumtransit.com/gtfs/nsn-nz/nsn-nz.zip", "nelson")),
    DataSource("taranaki_gtfs", "New Plymouth Citylink GTFS",
        ["transit_stops"],
        lambda conn, log=None: _load_regional_gtfs(conn, log,
            "https://data.trilliumtransit.com/gtfs/trc-nz/trc-nz.zip", "taranaki")),
    DataSource("palmerston_gtfs", "Palmerston North Horizons GTFS",
        ["transit_stops"],
        lambda conn, log=None: _load_regional_gtfs(conn, log,
