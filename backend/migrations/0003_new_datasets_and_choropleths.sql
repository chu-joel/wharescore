-- 07-report-function.sql
-- Single PL/pgSQL function: one call, one round-trip, full report as JSON.
-- Each section is an independent LATERAL subquery hitting its own GIST index.
-- Target: <50ms for any address.
